...
public class Permissions extends Permission {
	...
	public static final Permission CAPE_LIST_ALL = new Permissions("toybox.cape.list.all", "Allows viewing all capes", PermissionDefault.OP);
	...
	public static final Permission CLASS_LIST = new Permissions("toybox.class.list", "Allows a player to list classes");
	...
	public static final Permission CLASS_SET_OTHER = new Permissions("toybox.class.set.other", "Allows a player to set other people's classes", PermissionDefault.OP);
	public static final Permission CLASS_SET_OVERRIDE = new Permissions("toybox.class.set.override", "Allows a player to override class restrictions", PermissionDefault.OP);
	...
	public static final Permission CAPE_ALL = new Permissions("toybox.cape.*", "Allows access to all cape commands", PermissionDefault.OP, new Permission[] { CAPE_DENY, CAPE_GRANT, CAPE_LIST, CAPE_LIST_ALL, CAPE_SET_OWN, CAPE_SET_OTHER, CAPE_SET_OVERRIDE });
	public static final Permission CLASS_ALL = new Permissions("toybox.class.*", "Allows access to all class commands", PermissionDefault.OP, new Permission[] { CLASS_LIST, CLASS_SET_OWN, CLASS_SET_OTHER, CLASS_SET_OVERRIDE });
	public static final Permission CLASSES_ALL = new Permissions("toybox.classes.*", "Allows access to all classes", new Permission[] { CLASSES_ALCHEMIST, CLASSES_ARCHER, CLASSES_COOK, CLASSES_ENCHANTER, CLASSES_FARMER, CLASSES_LUMBERJACK, CLASSES_OREWORKER, CLASSES_OUTSIDER, CLASSES_WARRIOR });
