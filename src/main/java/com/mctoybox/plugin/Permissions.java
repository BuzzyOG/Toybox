...
public class Permissions extends Permission {
	...
	public static final Permission CAPE_LIST_ALL = new Permissions("toybox.cape.list.all", "Allows viewing all capes", PermissionDefault.OP, new Permission[] { CAPE_LIST });
	...
	public static final Permission CLASS_LIST_ALL = new Permissions("toybox.class.list.all", "Allows a player to list all classes", PermissionDefault.OP, new Permission[] { CLASS_LIST });
